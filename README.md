...
**NOTE:** The current version (v1) tends to have a fair number of false negative detections. The human-in-the-loop addition is meant to adjust the automatic count to ensure accuracy. All images are highly recommended to be checked post-inference manually to make any necessary corrections.
...
5. **Manual adjustment (Human-in-the-Loop correction)**  
